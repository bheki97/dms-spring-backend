package com.bheki97.dmsspringbackend.config.security.userdetails;
...
public class UserEntityUserdetails implements UserDetails {
    ...
    public UserEntityUserdetails(UserEntity userEntity){
        ...
        this.grantedAuthorities = Collections.singletonList(new SimpleGrantedAuthority(userEntity.getUserRole()));
